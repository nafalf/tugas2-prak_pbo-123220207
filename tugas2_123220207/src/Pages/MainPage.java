...
public class MainPage extends JFrame implements ActionListener {
    ...
    MainPage(String username, String jenisKelamin) {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            if (e.getSource() == tombolHasil) {
                ...
                inputTinggi.setText("");
                remove(labelLuas);
                remove(labelKeliling);
                remove(labelVolume);
                remove(labelLuasPermukaan);

                remove(labelHasilLuas);
                remove(labelHasilKeliling);
                remove(labelHasilVolume);
                remove(labelHasilLuasPermukaan);
            ...
            //Menampilkan pesan apabila input string
            JOptionPane.showMessageDialog(this, "Masukkan angka bukan String");
